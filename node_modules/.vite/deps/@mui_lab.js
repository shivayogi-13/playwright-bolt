...
import "./chunk-CLQK5HVC.js";
import "./chunk-PR6BAYEW.js";
import "./chunk-RJATZRYL.js";
import {
  require_react_dom
...
var TextareaAutosize = React85.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  const renders = React85.useRef(0);
  const [state, setState] = React85.useState({
    outerHeightStyle: 0
  });
  const getUpdatedState = React85.useCallback(() => {
